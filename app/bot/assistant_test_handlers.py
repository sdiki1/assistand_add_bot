...
INTRO_MESSAGE_1 = (
    ...
    "Я подготовила тест, который поможет определить, какой ты тип ассистента руководителя из ядра твоей личности."
    "</i>"
)

INTRO_MESSAGE_2 = (
    "<i>"
    "После прохождения теста я пришлю тебе файл с рекомендациями.\n"
    "Понимание своего сильного ядра позволит выстроить работу так, чтобы руководитель не утопал в бесконечных мелких "
    "задачах, а мог сосредоточиться на решениях, которые действительно двигают бизнес вперёд.\n\n"
...
RESULT_TEXTS = {
    "OFFICE": (
        ...
        "ААА, быстрее открывай файл с разбором — там подробно про твоё ассистентское ядро, сильные стороны и как "
    ...
    "PERSONAL": (
        ...
        "ААА, скорее открывай файл с разбором — там подробно про твоё ассистентское ядро, сильные стороны и как выстроить "
    ...
    "MULTI": (
        ...
        "И да… файл получился очень красивый и максимально прикладной 💔\n\n"
        "👀 И теперь главный вопрос: а какого типа ассистентов больше всего?\n"
